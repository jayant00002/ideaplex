...
export const SpeakerView = () => {
  ...
  const allOtherParticipants = [...participants, ...screens]
  const otherParticipants = useMemo(
    () => allOtherParticipants.filter(({ isLocal, isScreenshare }) => !isLocal || isScreenshare),
    [participants, screens, allOtherParticipants]
  );
