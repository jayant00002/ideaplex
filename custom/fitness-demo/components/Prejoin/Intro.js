    ...
    <div className="intro">
      ...
      <Card>
        <form onSubmit={(e) => {
          ...
          <div className="jc-card">
            <CardHeader>Create a meeting</CardHeader>
            <CardBody>
              {error && (
                <Well variant="error">
                  Failed to create meeting <p>{error}</p>
                </Well>
              )}
              {tokenError && (
                <Well variant="error">
              ...
              <Field label="Give your Meeting a name">
                <TextInput
                  type="text"
              ...
              <Field label="Privacy">
                <p> Private (attendees will request access to meeting)</p>
              </Field>
            </CardBody>
            <CardFooter>
              <Button
                ...
                type="submit"
              >
                {fetching ? 'Creating...' : 'Create meeting'}
              </Button>
            </CardFooter>
          </div>
        </form>
